...
#SBATCH --job-name=tg_sub           # Job name
#SBATCH --output=tg_sub-%j.log      # Standard output and error log
...
module load conda
conda activate mne
# python -m 04_source.time_gen.timeg_net_subreg.py
python -m 04_source.time_gen.timeg_net_subreg_merged.py
