...
for subject in subjects[:1]:
    ...
    for session_id, session in enumerate(sessions):
        ...
        clf = make_pipeline(StandardScaler(), LogisticRegression(multi_class="ovr", max_iter=100000, solver='lbfgs', class_weight="balanced", random_state=42))
    ...
    fig.suptitle(f'{subject} / $ sensor space $ / LogReg no class weight')
