...
seg_df = pd.read_csv(FIGURES_DIR / "TM" / "em_segments_rs_tr_source_subreg.csv")
...
sig_df = pd.read_csv(FIGURES_DIR / "TM" / "smooth_rs_tr_source_subreg.csv")
...
for network in networks:
    ...
    fig.savefig(figures_dir / f"rsa-net-subreg-{network}.pdf", transparent=True)
    plt.close()
    ...
    df.to_csv(FIGURES_DIR / "TM" / "data" / f'{network}_subreg_tr.csv', index=False, sep=",")
