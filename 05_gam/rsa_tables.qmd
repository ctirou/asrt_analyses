...
df.sensors <- bind_rows(
  read_csv(paste0("./gam/data/rsa_sensors_tr_step", py$step, ".csv")) %>% mutate(metric = "RS", .before = 1),
  read_csv(paste0("./gam/data/rsa_sensors_tr_corr_step", py$step, ".csv")) %>% mutate(metric = "RS CORR", .before = 1),
) %>% 
